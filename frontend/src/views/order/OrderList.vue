<template>
  <div class="orders-page">
    <div class="container">
      <div class="orders-page__header animate-fade-up">
        <span class="section-label">My Orders</span>
        <h1 class="orders-page__title">我的订单</h1>
      </div>

      <!-- Tabs -->
      <div class="orders-page__tabs animate-fade-up">
        <button
          v-for="tab in tabs"
          :key="tab.value"
      ...
      <div class="orders-page__list" v-loading="loading">
        <div
          ...
          :key="order.id"
          class="order-card animate-fade-up"
        ...
        >
          ...
          <div class="order-card__items">
            ...
            <span v-if="order.items?.length > 3" class="order-card__more">
        ...
        <div v-if="!loading && orders.length === 0" class="orders-page__empty">
          <span>📦</span>
          <h3>暂无订单</h3>
...
.orders-page {
  ...
  &__empty {
    ...
    h3 { font-size: 18px; color: $navy; margin-bottom: 12px; }
    a { color: $gold; font-weight: 500; }
  }
...
.order-card {
  ...
  &:hover {
    box-shadow: 0 8px 24px rgba($navy, 0.06);
